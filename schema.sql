...
CREATE TABLE `patients` (
  ...
  `patPostcode` varchar(20) NOT NULL,
  `patContact` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pateints_id_uindex` (`id`)
...
-- Dump completed on 2018-02-05 15:54:46
